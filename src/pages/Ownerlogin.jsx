...
const handleSubmit=(event)=>{
  ...
  axios.post('http://localhost:4000/ownerlogin', { email, password })
  //if this api call returns a response then i will allow the user to login//
  .then((res)=>{
  ...
  .catch((err)=>{
    ...
    console.error(err);
    setErrorMessage('Error occured while loging in');
  });
};
            ...
            <form  method="POST" onSubmit={handleSubmit}>
              ...
              <div className="mt-4 flex justify-center">
                ...
                <a
                  ...
                  className="ml-2 text-orange-500 hover:text-orange-700"  onClick={handleRegisterClick}
                >
                  Register now
                </a>
